...
class email {
	...
	public function sendContactRequestEmail($name, $email, $phone, $message) {
		$error_msg = "";
		$msg = "Hello,<br><br>I am ".$name.".<br><br>".$message."<br><br>Contact Information : <br>Email - ".$email."<br>Phone Number - ".$phone."<br><br>Thanks";
